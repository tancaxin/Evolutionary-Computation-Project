...
NUM_RUNS = 5
print("="*80)
print("EXPERIMENT 21: Rank Selection")
print("="*80)
print(f"Config: Pop=100, Mut=0.5, Cross=one_point, Sel=rank")
...
for run in range(NUM_RUNS):
    ...
    gens, best_ind, best_fit, _ = genetic_algorithm(
        ...
        selection_method='rank', crossover_method='one_point',
