"""
Experiment 4: Very High Mutation Rate
"""
...
NUM_RUNS = 5
print("="*80)
print("EXPERIMENT 4: Very High Mutation Rate")
print("="*80)
print(f"Config: Pop=100, Mutation=0.9, Crossover=OFF, Sel=tournament")
...
for run in range(NUM_RUNS):
    ...
    gens, best_ind, best_fit, _ = genetic_algorithm(
        ...
        mutation_rate=0.9,          
        crossover_rate=0.0,          # irrelevant since crossover is off
